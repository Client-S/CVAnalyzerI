    ...
    public partial class MigrationName : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentClusters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentClusters_AspNetUsers_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_AspNetUsers_UploadedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClusterMembers_StudentClusters_ClusterId",
                        column: x => x.ClusterId,
                        principalTable: "StudentClusters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CVDocuments_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtractedText = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClusterMembers_ClusterId_StudentId",
                table: "ClusterMembers",
                columns: new[] { "ClusterId", "StudentId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CVDocuments_ProcessingStatus",
                table: "CVDocuments",
                column: "ProcessingStatus");

            migrationBuilder.CreateIndex(
                name: "IX_CVDocuments_StudentId",
                table: "CVDocuments",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_UploadedByUserId",
                table: "Students",
